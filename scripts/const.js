...
export const WEATHER_VARIABLES = [
    ...
    "wctrl.weather.tracker.extreme.Extreme",
    ...
    "wctrl.weather.tracker.MorrsliebFull",
    "wctrl.weather.tracker.normal.Ashen",
    "wctrl.weather.tracker.normal.Ashfall",
    "wctrl.weather.tracker.normal.Blizzard",
    "wctrl.weather.tracker.normal.Clear",
    "wctrl.weather.tracker.normal.Dark",
